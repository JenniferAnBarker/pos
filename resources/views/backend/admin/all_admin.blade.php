        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">All Admin Users <span class="btn btn-danger">{{ count($allAdminUsers)}}</span> </h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
                    ...
                    <div class="card-body">
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key+1}}</td>
                                    <td> <img src="{{(!empty($item->photo)) ? url('upload/admin_images/'.$item->photo) : url('upload/no_image.png') }}" style="width:50px; height:40px;"> </td>
                                    <td>{{ $item->name}}</td>
                                    <td>{{ $item->email}}</td>
                                    <td>{{ $item->phone}}</td>
                                    <td> 
