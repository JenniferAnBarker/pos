                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('add.roles.permission')}}" class="btn btn-primary rounded-pill waves-effect waves-light">Add Role in Permissions</a>
                        </ol>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @foreach($item->permissions as $perm)
                                        <span class="badge rounded-pill bg-pink">{{ $perm->name}}</span>
                                    @endforeach
                                    </td>
                                    <td width="18%">
